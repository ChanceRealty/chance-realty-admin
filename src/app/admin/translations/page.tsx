...
// // src/app/admin/page.tsx - Updated with translation info
// 'use client'
...
// 			if (response.ok) {
// 				const translationStats = await response.json()
// 				setStats(prevStats => ({
// 					...prevStats,
// 					translationStats,
// 				}))
...
// 	const getTranslationBadge = (property: PropertyListItem) => {
// 		const hasRussian = !!property.title_ru
// 		const hasEnglish = !!property.title_en
...
// 									{stats.translationStats?.fully_translated || 0}
// 								</p>
// 							</div>
// 						</div>
// 					</div>
...
// 									{stats.translationStats.fully_translated}
// 								</div>
// 								<div className='text-sm text-gray-500'>Fully Translated</div>
// 							</div>
// 							<div className='text-center'>
// 								<div className='text-2xl font-bold text-orange-600'>
// 									{stats.translationStats.partially_translated}
// 								</div>
// 								<div className='text-sm text-gray-500'>Partially Translated</div>
// 							</div>
// 							<div className='text-center'>
// 								<div className='text-2xl font-bold text-red-600'>
// 									{stats.translationStats.not_translated}
// 								</div>
// 								<div className='text-sm text-gray-500'>Not Translated</div>
// 							</div>
// 							<div className='text-center'>
// 								<div className='text-2xl font-bold text-blue-600'>
// 									{Math.round((stats.translationStats.fully_translated / stats.translationStats.total_properties) * 100)}%
// 								</div>
...
// 				{/* Mobile Cards View - Updated with translation info */}
